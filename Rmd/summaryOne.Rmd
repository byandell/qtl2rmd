...
**Want to incorporate this into mediation_qtl2 and probably have a plot method that has lines for the `snp_ct_n` stuff. Then we will have smaller objects saved, etc.**

**Got stuff in mediation_qtl2. Need to refactor data. Need to migrate listof_... to mediation_qtl2.**
